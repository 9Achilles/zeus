...
import zeus.callback.ZeusWorkerRPCCallBack;
...
@Service
public class ZeusWorkerRPCServiceImpl implements ZeusWorkerRPCService {
    ...
    public void doPost(String url, String head, String body) {
        ...
        httpclient.execute(httpPost, new ZeusWorkerRPCCallBack());
    }
